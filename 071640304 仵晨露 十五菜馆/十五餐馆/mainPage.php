...
<div class="sign">
    ...
    <span class="dismiss" id="registDismiss">&times;</span>
    ...
    <form action="javascript:;">
        ...
        <img src="" style="box-shadow:0 0 1px slategray;vertical-align: -9px;margin-right: 2px" id="identifyImg1"/>
...
<div class="register">
    ...
    <span class="dismiss" id="loginDismiss">&times;</span>
    <form action="javascript:;">
        ...
        <img src="" style="box-shadow:0 0 1px slategray;vertical-align: -9px;margin-right: 2px" id="identifyImg"/>
        <a class="identifySpan" style="color: darkblue;cursor:pointer;font-size: 12px;font-weight: 500;"
