...
$sql = "update orderinfo set state = 2 where orderId = '$orderId';";
$sql3 = "UPDATE orderinfo set arriveTime = '$time' where orderId = $orderId ;";
if(mysqli_query($con,$sql)){
    if(mysqli_query($con,$sql3)){

        $sql12 = "SELECT * from orderinfo where userName = '".$_SESSION['userName']."' order by buyTime desc;";$query12 = mysqli_query($con,$sql12);
